...
TESTS {
	...
	//code_cases	 check the correct symbol to be read then write the code for that symbol to a file
	//MUL
	char buf[4]; 	//allocate space testing codes
	test_read = fopen("test_read.txt", "r");
    ...
    fgets(buf, 4, test_write); //get the code from the FILE code_cases wrote to then compare it with expected code
